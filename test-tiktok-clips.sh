...
VIDEO_NAME="tiktok_test_video.mp4"
VIDEO_SIZE=$(stat -c %s "$VIDEO_PATH")
VIDEO_DURATION=75

echo "🎬 TESTE DE CLIPS PARA TIKTOK - VERSÃO MELHORADA"
echo "=================================================="
...
# =============== PASSO 2: Upload para Cloudinary ===============
echo "\n☁️ PASSO 2: Upload para Cloudinary..."
...
echo "\n⏳ Aguardando processamento (30s)..."
sleep 30

# =============== PASSO 6: Análise para TikTok ===============
echo "\n🧠 PASSO 5: Análise otimizada para TikTok..."
...
# =============== PASSO 7: Aguardar geração ===============
echo "\n⏳ Aguardando geração de clips (90s)..."
sleep 90

# =============== PASSO 8: Verificar clips ===============
